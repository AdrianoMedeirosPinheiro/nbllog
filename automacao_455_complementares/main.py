...
with sync_playwright() as p:
    ...
    time.sleep(3)
    gerar_relatorio.gerar_relatorios_ultimos_12_meses(popup_page)
    time.sleep(3)
    ...
    download_directory = "/nbllog/automacao_455_complementares/base"
    ...
    diretorio = '/nbllog/automacao_455_complementares/base'  # Caminho para o diretório dos arquivos .sswweb
    tabela_destino = 'relatorios455complementares'  # Nome da tabela no PostgreSQL

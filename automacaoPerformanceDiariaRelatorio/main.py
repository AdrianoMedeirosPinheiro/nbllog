...
with sync_playwright() as p:
    ...
    time.sleep(2)
    download_directory = "/nbllog/automacaoPerformanceDiariaRelatorio/base" 
    ...
    time.sleep(2)
    diretorio = r'/nbllog/automacaoPerformanceDiariaRelatorio/base'
    ...
    diretorio = '/nbllog/automacaoPerformanceDiariaRelatorio/base/resultado_processado.xlsx'  # Caminho para o diretório dos arquivos .sswweb

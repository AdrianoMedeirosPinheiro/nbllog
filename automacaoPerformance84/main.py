...
with sync_playwright() as p:
    ...
    time.sleep(2)
    download_directory = "/nbllog/automacaoPerformance84/base" 
    ...
    time.sleep(2)
    diretorio = r'/nbllog/automacaoPerformance84/base'
    ...
    diretorio = '/nbllog/automacaoPerformance84/base/resultado_processado.xlsx'  # Caminho para o diretório dos arquivos .sswweb

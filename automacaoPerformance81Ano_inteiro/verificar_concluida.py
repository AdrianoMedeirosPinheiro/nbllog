...
def verificar_situacao_concluida(new_page, criterios_opcao, criterios_usuario, config_verificar_todos=False, update_button_selector='#\\32', tabela_selector='#tblsr > tbody > tr'):
    ...
    while True:
        ...
        if config_verificar_todos:
            ...
            # Seleciona apenas as 3 linhas mais recentes
            filtered_rows_atualizado = todas_linhas[:3]
...
# Exemplo de uso:
# Para verificar apenas as 3 últimas linhas
# filtered_rows_atualizado = verificar_situacao_concluida(new_page, criterios_opcao, criterios_usuario, config_verificar_todos=False)

# Para verificar as linhas do ano atual e do ano anterior
# filtered_rows_atualizado = verificar_situacao_concluida(new_page, criterios_opcao, criterios_usuario, config_verificar_todos=True)
